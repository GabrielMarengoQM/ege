box::use(
  ...
  shinyWidgets[pickerInput, progressBar, updateProgressBar, pickerOptions, materialSwitch, awesomeCheckbox,
               multiInput, updateMultiInput, dropdownButton, tooltipOptions],
  dplyr[...],
  stats[na.omit],
    ...
    fluidRow(
      column(
        ...
        dropdownButton(
          ...
          circle = FALSE, status = 'filterBtnClass',
          icon = icon("sliders"), width = "100%",
